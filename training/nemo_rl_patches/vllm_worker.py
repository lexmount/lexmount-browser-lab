...
class BaseVllmGenerationWorker:
    ...
    def __init__(
        ...
        llm_kwargs = dict(
            ...
            # Compatibility hook for Stagehand v3: a legacy OpenAI alias forces
            # Chat Completions while model weights still load from model_name.
            served_model_name=self.cfg["vllm_cfg"].get(
